...
export default function CouncilMember({ name, role, description }: CouncilMemberProps) {
  return (
    <div className="text-center group">
      <div className="w-48 h-48 mx-auto mb-6 bg-port-mist rounded-full overflow-hidden flex items-center justify-center transition-transform group-hover:scale-105">
