...
const articles: Record<string, Article> = {
  "sarah-martinez": {
    ...
    content: [
      ...
      "BEYOND THE PANTRY:",
      "In 2020, the Network launched its Kitchen Skills Series, offering free, bi-weekly cooking classes held at Harbor Community Center that teach budget cooking, nutrition literacy, and meal planning. In 2022, a culinary job training track launched in partnership with the Port Laken Workforce Development Office.",
  ...
  "summer-festival": {
    ...
    subtitle: "Three days, 40+ food vendors, five music stages, a parade, and the 5K that fills up in 48 hours. Here's the full schedule for Port Laken's biggest annual celebration",
    category: "Events",
    author: "Port Laken News",
  ...
  "tsa-states-spokane": {
    ...
    title: "Lakefront High TSA Club Is Headed to States in Spokane",
    subtitle: "The Technology Student Association chapter at Lakefront High School has earned its spot at the Washington State TSA Conference — and they're ready to compete",
    category: "Community Spotlight",
    author: "Port Laken News",
    date: "March 20, 2026",
    readTime: "5 min read",
    image: "https://scontent-sea5-1.xx.fbcdn.net/v/t39.30808-6/514323333_1130642375748016_7452580614864964269_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=7b2446&_nc_ohc=EkIVX4nlwfcQ7kNvwEeEbja&_nc_oc=AdrFEfqud7g3L9l0zX5XQ976_i3-G13FtAWkhi3y7HtygCB8eQDhbs6nlaHygML5uj0&_nc_zt=23&_nc_ht=scontent-sea5-1.xx&_nc_gid=TS17QFZdmLzRyEBkUgwujw&_nc_ss=7a30f&oh=00_AfzulIS6o6EvYVc6k6BqQMXH_0L-85V3dYY0END1EPKUcA&oe=69C3B464",
    content: [
